# MinnPost Minneapolis City Council Questionnaire

An interactive look at the city council views on specific questions.

## Data

Data was collected with a questionnaire sent out to select city coulcil members by MinnPost.

## Data processing

Data is downloaded from a [Google Spreadheet](https://docs.google.com/a/minnpost.com/spreadsheet/ccc?key=0AjYft7IGrHzNdFBlV0dxLUlHVjlMcEZ2NWQ1bm9LNXc).  Use the following to get a new local copy:
